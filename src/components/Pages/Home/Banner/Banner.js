            ...
            <div className='grid gap-5 grid-cols-1 md:grid-cols-2 items-center my-20 px-10 md:px-20'>
                ...
                <div>
                    ...
                    <Link to={cv} target="_blank" download>
                        <button className='btn btn-white btn-outline my-10 rounded-full shadow-2xl'>Download Resume <span className='text-xl ml-3 font-bold'><AiOutlineDownload /></span></button></Link>
                </div>
