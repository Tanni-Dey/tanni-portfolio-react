...
import digitegrity from "../../../../images/digitegrity1.png";
import digitegrity2 from "../../../../images/digitegrity2.png";
import digitegrity3 from "../../../../images/digitegrity3.png";
import telecare from "../../../../images/Screenshot_70.png";
import telecare2 from "../../../../images/Screenshot_71.png";
import telecare3 from "../../../../images/Screenshot_72.png";
...
const Projects = () => {
  ...
  const allProject = [
    {
      ...
      img2: bookCloset2,
      img3: bookCloset3,
      des: "This is a book warehouse website. It has 100+ books. User can signup with social login or email password login. After login he/she can add many books in this website and show this books manage books page and my books page. Upcomming book section has see in home page",
      tech: "Warehouse Project : HTML, CSS, Tailwind CSS, React JS, JWT",
      live: "https://book-closet.web.app/",
      clientCode: "https://github.com/Tanni-Dey/book-closet-client",
    ...
    },
    {
      ...
      img2: partsIndusto2,
      img3: partsIndusto3,
      des: "This is a Tv parts manufacturing website. User can signup with social login or email password login. After login he/she can purchase any product. After order, he can payment with his/her credit card.He can Update his/her profile if he/she want. It has a admin panel in this website, admin can only accees this panel. User can See About Our business, he/she can see home page.",
      tech: "Manufacture Project : HTML, CSS, Tailwind CSS, React JS, Daisy UI, JWT, Stripe",
      live: "https://parts-industo.web.app/",
      clientCode: "https://github.com/Tanni-Dey/parts-industo-client",
      serverCode: "https://github.com/Tanni-Dey/parts-industo-server",
    },
    {
      id: 3,
      name: "Todo App",
      ...
      img2: todo2,
      img3: todo3,
      des: "This is a Todo App. All todo has in todo list page and user can add, update and delete their task.",
      tech: "Todo Project : HTML, CSS, Tailwind CSS, React JS, Firebase, JWT, Express Js",
      live: "https://todo-app-b2ac2.web.app/",
      clientCode: "https://github.com/Tanni-Dey/hellwet_todo_frontend",
      serverCode: "https://github.com/Tanni-Dey/hellwet_todo_backend",
    },
    {
      id: 4,
      name: "Furniture Review",
      img: furnitureReview,
      img2: furnitureReview2,
      img3: furnitureReview3,
      des: "This is a customer reviews site.All reviews has in reviews page and some reviews showing in customer review section in home page.Some charts has in dashboard page.",
      tech: "Reviews Project : HTML, CSS, Tailwind CSS, React JS, Firebase",
      live: "https://furniture-review.netlify.app/",
      clientCode: "https://github.com/Tanni-Dey/furniture-review",
    },
    {
      id: 5,
      name: "React Native signup",
      img: native,
      img2: native,
      img3: native,
      des: "This is React Native Signup page with firebase",
      tech: "Signup Project : React Native, Firebase",
      live: "#",
      clientCode: "https://github.com/Tanni-Dey/tricky-task",
    },

    {
      ...
      img2: digitegrity2,
      img3: digitegrity3,
      des: "This is a software development company website. This is only frontend design.",
      tech: "Corporate Project : HTML, CSS, Bootstrap, JavaScript, Jquery",
      live: "https://digiterity.netlify.app/",
      clientCode: "https://github.com/Tanni-Dey/Digiterity",
    },
    {
      id: 7,
      name: "Telecare Template",
      img: telecare,
      img2: telecare2,
      img3: telecare3,
      des: "This is a figma to html template. This is only frontend design.",
      tech: "Telecare Project : HTML, CSS, Bootstrap, JavaScript, Jquery",
      live: "https://telecare-template.netlify.app/",
      clientCode: "https://github.com/Tanni-Dey/telecare",
    },
  ];
  ...
  return (
    <div id="projects">
      ...
      <h2 className="text-5xl font-serif text-primary text-center font-bold">
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-3 my-20 px-10 md:px-20">
        {allProject.map((project) => (
          <div key={project.id} class="card shadow-xl single-project">
            <figure>
              <img className="p-img" src={project.img} alt={project.name} />
            </figure>
              ...
              <div class="card-actions justify-end">
                {project.serverCode && (
                  <a
                    ...
                    class="badge badge-outline text-black font-bold hover:bg-secondary hover:text-white hover:py-1"
                  >
                    Server <BsGithub className="ml-3" />
                  </a>
                )}
                <a
                  href={project.clientCode}
                  target="_blank"
                  class="badge badge-outline hover:bg-primary hover:text-white hover:py-1 text-black font-bold"
                >
                  Client <BsGithub className="ml-3" />
                </a>
                <label
                  onClick={() => setProject(project.id)}
                  for="my-modal-6"
                  className="badge badge-outline hover:bg-primary hover:text-white hover:py-1 text-black font-bold"
                >
                  Details
                </label>
                {/* 
